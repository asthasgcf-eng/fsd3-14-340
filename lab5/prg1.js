...
app.get("/about", (req,res)=>{
    res.sendFile(path.join(dirname, "public", "about.html"));     //projectFolder/public/about.html

});

app.get("/enquiry", (req,res)=>{
    res.sendFile(path.join(dirname, "public", "enquiry.html"));    //projectFolder/public/enquiry.html
